MODULE = Data::Buffer::Shared    PACKAGE = Data::Buffer::Shared::U16
PROTOTYPES: DISABLE
...
new(char* class, char* path, UV capacity)
    CODE:
        ...
        BufHandle* buf = buf_u16_create(path, (uint64_t)capacity, errbuf);
...
get(SV* self_sv, UV idx)
    CODE:
        ...
        uint16_t val;
        if (!buf_u16_get(h, (uint64_t)idx, &val)) XSRETURN_UNDEF;
        RETVAL = newSVuv(val);
    OUTPUT:
        RETVAL
...
set_slice(SV* self_sv, UV from, ...)
    CODE:
        ...
        RETVAL = buf_u16_set_slice(h, (uint64_t)from, (uint64_t)count, tmp);
    OUTPUT:
        RETVAL
...
fill(SV* self_sv, UV val)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        buf_u16_fill(h, (uint16_t)val);

SV*
incr(SV* self_sv, UV idx)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_incr(h, (uint64_t)idx));
    OUTPUT:
        RETVAL
...
decr(SV* self_sv, UV idx)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_decr(h, (uint64_t)idx));
    OUTPUT:
        RETVAL
...
add(SV* self_sv, UV idx, UV delta)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_add(h, (uint64_t)idx, (uint16_t)delta));
    OUTPUT:
        RETVAL
...
cas(SV* self_sv, UV idx, UV expected, UV desired)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        RETVAL = buf_u16_cas(h, (uint64_t)idx, (uint16_t)expected, (uint16_t)desired);
    OUTPUT:
        RETVAL
...
unlink(SV* self_or_class, ...)
    CODE:
        ...
        if (SvROK(self_or_class)) {
            ...
            else croak("Data::Buffer::Shared::U16: destroyed object");
        } else {
...
ptr_at(SV* self_sv, UV idx)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        void *p = buf_u16_ptr_at(h, (uint64_t)idx);
        if (!p) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = PTR2UV(p);
    OUTPUT:
        RETVAL
...
new_anon(char* class, UV capacity)
    CODE:
        char errbuf[BUF_ERR_BUFLEN];
        BufHandle* buf = buf_u16_create_anon((uint64_t)capacity, errbuf);
        if (!buf) croak("Data::Buffer::Shared::U16: %s", errbuf[0] ? errbuf : "unknown error");
        RETVAL = sv_setref_pv(newSV(0), class, (void*)buf);
    OUTPUT:
        RETVAL
...
get_raw(SV* self_sv, UV byte_off, UV nbytes)
    CODE:
        ...
        if (!buf_u16_get_raw(h, (uint64_t)byte_off, (uint64_t)nbytes, SvPVX(RETVAL))) {
            SvREFCNT_dec(RETVAL);
            croak("Data::Buffer::Shared::U16: get_raw out of bounds");
        }
    OUTPUT:
        RETVAL
...
set_raw(SV* self_sv, UV byte_off, SV* data_sv)
    CODE:
        ...
        RETVAL = buf_u16_set_raw(h, (uint64_t)byte_off, (uint64_t)dlen, dptr);
    OUTPUT:
        RETVAL
...
cmpxchg(SV* self_sv, UV idx, UV expected, UV desired)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_cmpxchg(h, (uint64_t)idx, (uint16_t)expected, (uint16_t)desired));
    OUTPUT:
        RETVAL
...
atomic_and(SV* self_sv, UV idx, UV mask)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_atomic_and(h, (uint64_t)idx, (uint16_t)mask));
    OUTPUT:
        RETVAL
...
atomic_or(SV* self_sv, UV idx, UV mask)
    CODE:
        EXTRACT_BUF("Data::Buffer::Shared::U16", self_sv);
        if (idx >= h->hdr->capacity) croak("Data::Buffer::Shared::U16: index out of bounds");
        RETVAL = newSVuv(buf_u16_atomic_or(h, (uint64_t)idx, (uint16_t)mask));
    OUTPUT:
        RETVAL
...
create_eventfd(SV* self_sv)
    CODE:
        ...
        if (RETVAL < 0) croak("Data::Buffer::Shared::U16: eventfd: %s", strerror(errno));
    OUTPUT:
        RETVAL
